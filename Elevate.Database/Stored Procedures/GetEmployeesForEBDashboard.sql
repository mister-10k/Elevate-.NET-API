...
BEGIN  
 ...
 BEGIN  
  IF(@SortColumn = 'Id')  
         SET @SortColumn = 'Id DESC,';  
  IF(@SortColumn = 'FirstName')  
         SET @SortColumn = 'FirstName DESC,';  
  IF(@SortColumn = 'LastName')  
         SET @SortColumn = 'LastName DESC,';  
  IF(@SortColumn = 'Company')  
         SET @SortColumn = 'Company DESC,';  
  IF(@SortColumn = 'Email')  
         SET @SortColumn = 'Email DESC,';  
  IF(@SortColumn = 'CreatedAt')  
         SET @SortColumn = 'CreatedAt DESC,';  
 END;  
